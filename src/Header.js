      ...
      <nav className="navbar navbar-dark bg-dark">
        <div className="dropdown">
          ...
          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <span className="dropdown-item" onClick={() => dispatch(UiStateSlice.setActiveMenuItem(2))}>Add Peronal Data</span>
            <span className="dropdown-item" onClick={() => dispatch(UiStateSlice.setActiveMenuItem(3))}>Cahrt Example</span>
          </div>
        </div>
        <div>
